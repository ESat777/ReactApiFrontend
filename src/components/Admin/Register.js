...
const Register = () => {
  ...
  return (
    <div className="d-flex aligns-items-center justify-content-center m-4">
      <div className="card w-50">
        <div className="card-header text-center fs-4 fw-bolder bg-info">
          Register
        </div>
        <div className="card-body">
          ...
          <form onSubmit={(e) => register(e)}>
            ...
            <div className="form-group d-grid gap-2">
              <label className="form-label mb-0 fs-5">Name</label>
              <input
              ...
              />
              <label className="form-label mt-2 mb-0 fs-5">
